...
fn decode_sync_response_tolerant<P: serde::de::DeserializeOwned>(
    ...
    Ok(match raw {
        ...
        // Snapshot sync is node-to-node; an indexer replays every block and
        // never requests one, so these are only ever passed through.
...
fn track_sync_request(
    ...
    if let Some(request_id) = send_sync_request(swarm, peer, request) {
        ...
        let pending = match request {
            ...
            SyncRequest::SnapshotManifest { .. } | SyncRequest::SnapshotChunk { .. } => {
                unreachable!("an indexer never requests a snapshot")
            }
        };
        ...
        match event {
            ...
            SwarmEvent::Behaviour(BehaviourEvent::Sync(request_response::Event::Message {
                ...
                match sync_response {
                    ...
                    SyncResponse::SnapshotManifest(_) | SyncResponse::SnapshotChunk { .. } => {
                        warn!(%peer, ?request_id, "ignoring unsolicited snapshot response");
                    }
                }
            }
...
mod tests {
    ...
    fn decodes_arxium_v020_block_fixture() {
        ...
        const V020_BLOCK_FIXTURE: &[u8] = &[
            ,
            ...
            ,
            ...
            0x74, 0x65, 0x2d, 0x72, 0x6f, 0x6f, 0x74, 0x2d, 0x35, 0x64, 0x34, 0x33,
            0x33, 0x30, 0x37, 0x34, 0x66, 0x36, 0x34, 0x34, 0x37, 0x36, 0x30, 0x31,
            0x64, 0x65, 0x34, 0x61, 0x64, 0x66, 0x34, 0x35, 0x39, 0x38, 0x39, 0x30,
            0x36, 0x31, 0x61, 0x65, 0x35, 0x35, 0x35, 0x31, 0x31, 0x33, 0x33, 0x66,
            0x00, 0x00,
        ];
